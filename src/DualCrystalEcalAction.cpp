...
namespace dd4hep {
  ...
  namespace sim   {
     ...
     *
     * @{
     * \package DualCrystalEcalAction 
     *
     * @}
     */

    /// Define collections created by this sensitivie action object
    template <> void Geant4SensitiveAction<DualCrystalEcal>::defineCollections()    {
      m_collectionID = declareReadoutFilteredCollection<CalVision::DualCrystalEcal::Hit>();
    }

    /// Method for generating hit(s) using the information of G4Step object.
    template <> bool Geant4SensitiveAction<DualCrystalEcal>::process(const G4Step* step,G4TouchableHistory* /*hist*/ ) {
...
//--- Factory declaration
namespace dd4hep { namespace sim {
    typedef Geant4SensitiveAction<DualCrystalEcal> DualCrystalEcalAction;
  }}
DECLARE_GEANT4SENSITIVE(DualCrystalEcalAction)
